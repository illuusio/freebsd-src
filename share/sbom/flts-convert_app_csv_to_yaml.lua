...
-- share/sbom/flts-convert_app_csv_to_yaml.lua share/sbom/data/FreeBSD-apps.csv output.yaml database_directory/database.yml
...
if #arg <= 2 then
	print("Usage:\tflts-convert_app_csv_to_yaml.lua [csv input file (separator '|')] [output.yaml] [input.json]\n")
