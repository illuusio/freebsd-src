...
-- share/sbom/convert_license_to_database.lua share/sbom/FreeBSD-license.csv database_directory/database.yml
...
if #arg <= 2 then
	print("Usage:\tpconvert_csv_to_json.lua [csv input file (separator '|')] [output.yaml] [input.json]\n")
